...
<html>
    ...
    <ul>
        ...
        <li class="has-sub">
            <a href="javascript:;" class="">
                <i class="fa fa-bookmark-o fa-fw"></i> <span class="menu-text">Estados</span>
                <span class="arrow"></span>
            </a>
            <ul class="sub">
    <li>
    <a class="" href="{{URL::to('crearEstado')}}">
    <span class="sub-menu-text">Agregar</span></a>
    </li>
    <li>
    ...
    <li class="has-sub">
    <a href="javascript:;" class="">
    <i class="fa fa-table fa-fw"></i> <span class="menu-text">Municipios</span>
    <span class="arrow"></span>
    </a>
    <ul class="sub">
    <li><a class="" href="{{URL::to('crearMunicipio')}}"><span class="sub-menu-text">Agregar</span></a></li>
    ...
    <li class="has-sub">
    <a href="javascript:;" class="">
    <i class="fa fa-pencil-square-o fa-fw"></i> <span class="menu-text">Articulación</span>
    <span class="arrow"></span>
    </a>
    <ul class="sub">
    <li><a class="" href="{{URL::to('crearArticulacion')}}"><span class="sub-menu-text">Agregar</span></a></li>
    ...
    <li class="has-sub">
    <a href="javascript:;" class="">
    <i class="fa fa-bar-chart-o fa-fw"></i> <span class="menu-text">Impacto</span>
    <span class="arrow"></span>
    </a>
    <ul class="sub">
    <li><a class="" href="{{URL::to('crearImpactos')}}"><span class="sub-menu-text">Agregar</span></a></li>
    ...
    <li class="has-sub">
    <a href="javascript:;" class="">
    <i class="fa fa-columns fa-fw"></i> <span class="menu-text">Subsistemas</span>
    <span class="arrow"></span>
    </a>
    <ul class="sub">
    <li><a class="" href="{{URL::to('crearSubsistemas')}}"><span class="sub-menu-text">Agreagar</span></a></li>
    ...
    <li class="has-sub">
    <a href="javascript:;" class="">
    <i class="fa fa-map-marker fa-fw"></i> <span class="menu-text">Personas</span>
    <span class="arrow"></span>
    </a>
    <ul class="sub">
    <li><a class="" href="{{URL::to('crearPersona')}}"><span class="sub-menu-text">Agregar</span></a></li>
